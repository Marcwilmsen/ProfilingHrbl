...
from .zoneCutter import cut_solution_in_masterAreas
...
def fitness_func(ga_generation, solution, solution_idx):
    ...
    master_zones = cut_solution_in_masterAreas(solution)
